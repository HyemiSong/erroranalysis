        ...
        children: [
          {
            ...
            level: 2,
            children: [
              { name: "BetweennessCentrality", size: 3534, level: 3 },
              { name: "LinkDistance", size: 5731, level: 3 }
            ]
          },
          {
            name: "optimization",
            level: 2,
            children: [
              { name: "AspectRatioBanker", size: 7074, level: 3 },
              { name: "CommunityStructure", size: 3812, level: 3 }
            ]
          }
        ]
      },
        ...
        children: [
          {
            ...
            level: 2,
            children: [
              { name: "line3_1", size: 1983, level: 3 },
              { name: "line3_0", size: 2047, level: 3 }
            ]
          },
          {
            name: "curve_2_1",
            level: 2,
            children: [
              { name: "curve3_0", size: 19813, level: 3,
                children: [
                    { name: "curve4_0", size: 983, level: 4 },
                    { name: "curve4_1", size: 207, level: 4 }
                ]
            },
              { name: "curve3_1", size: 2047, level: 3 }
            ]
          }
        ]
      }
